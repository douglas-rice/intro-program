...
def rps(fist1, fist2)
  if fist1 == "rock"
    (fist2 == "paper") ? "paper" : "rock" # if fist2 == paper, then paper wins
  elsif fist1 == "paper"
    (fist2 == "scissors") ? "scissors" : "paper" # if fist2 == scissors, then scissors wins
  else
...
# them by calling rps on their individual results. Those innermost 
# expressions will return "paper" and "rock", respectively. Calling 
# rps on that input will return "paper". Which finally when evaluated 
