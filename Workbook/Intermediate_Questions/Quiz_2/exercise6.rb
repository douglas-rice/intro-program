# One day Spot was playing with the Munster familiy's home computer and he wrote a 
...
# Did the family's data get ransacked, or did the mischeif only mangle a local copy 
...
# Why? Remember that in Ruby, what gets passed in the parameter list is not what it 
# appears. Under the hood, ruby passes the object id of each item rather than the 
# value of the parameter. The method internally stores these object id's in locally 
