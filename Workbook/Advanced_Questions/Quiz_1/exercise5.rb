...
# Alyssa supplied Ben with a method called is_a_number? to determine if 
# a string is a number and asked Ben to use it.
...
# note from Doug: apparently we're supposed to know that an IP address 
# can only contain 4 components.
...
# encountering a non-numeric component, he used break to break out of 
# the while loop. Once he breaks, control falls through to the return 
# true statement. He can fix this by performing return false instead of 
# break.
...
# be shortened to just `true`. This is because Ruby returns the result 
# of the last line of any method by default.
